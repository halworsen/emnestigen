...
function InfoPanel(props) {
	...
	const course_data = data[props.activeCourse];

	if(data[props.activeCourse]) {
	...
	return (
		...
		>
			...
			<div
				...
				className="titleBox"
			>	
				<CourseInput key="courseInput" value={props.activeCourse} onChange={(event) => props.onSearch(event.target.value)}/>
